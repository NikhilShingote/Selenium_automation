...
class BakeryOrderManagement:
    ...
    def add_order(self):
        ...
        self.orders.loc[len(self.orders.index)] = [customer_name, item, quantity, order_date]
    ...
    def update_order(self):
        ...
        if order_id >= len(self.orders):
            ...
            # The Orderid value is considered the index number by "at" method by default and "item" as column name
